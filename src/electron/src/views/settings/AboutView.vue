  ...
  <div class="h-full overflow-y-scroll">
    ...
    <div v-else class="mt-4">
      ...
      <article class="prose prose-lg mt-4">
        ...
        <p class="text-base">
          Various versions of PersonalAnalytics were thoroughly tested through more than a dozens
          field studies involving hundreds of users. Even though the software runs reliably on most
          systems, we cannot exclude occasional software issues. The use of this software is at the
          sole risk of the user. The creators of the software disclaim any liability for damages or
          consequences, including but not limited to damages or losses arising from the use,
          modification, or misuse of the software. The software is provided under an open-source
          license to researchers and users <i>as-is</i> and can be inspected under the link provided
          above.
        </p>
        <div class="float-end flex pb-7">
          ...
          <a href="https://hasel.dev" target="_blank">
            <img
              src="../../assets/logo_hasel.svg"
              class="m-0 w-44 object-contain"
              alt="HASEL Logo"
            />
          </a>
        </div>
